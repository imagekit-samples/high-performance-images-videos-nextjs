  ...
  return (
    <div className="flex max-w-200 mx-auto flex-1 mt-30 flex-col justify-center content-center">
      ...
      <Button asChild variant="outline" className="text-xl text-wrap bg-blue-500 text-white drop-shadow-none mt-10 max-w-100 mx-auto h-auto whitespace-pre-wrap">
        <Link href="/demo/normal-media-content">Normal Images and Videos</Link>
      </Button>
      <Button asChild variant="outline" className="text-xl text-wrap bg-blue-500 text-white drop-shadow-none mt-2 max-w-100 mx-auto h-auto whitespace-pre-wrap">
        <Link href="/demo/optimized-media-content">Optimized Images and Videos</Link>
      </Button>
    </div>
  )
}
